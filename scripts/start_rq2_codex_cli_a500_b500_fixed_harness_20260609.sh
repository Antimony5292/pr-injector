...
if screen -list | grep -q "[.]${A_SCREEN}[[:space:]]"; then
  ...
  screen -dmS "${A_SCREEN}" bash /Users/harmin/Desktop/pr-injector-main/scripts/launch_rq2_codex_cli_a500_fixed_harness_official_20260609.sh
...
if screen -list | grep -q "[.]${B_SCREEN}[[:space:]]"; then
  ...
  screen -dmS "${B_SCREEN}" bash /Users/harmin/Desktop/pr-injector-main/scripts/launch_rq2_codex_cli_b500_fixed_harness_20260609.sh
